...
namespace MaShops.DataAccess.Migrations
{
    ...
    [Migration("20240720094235_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaShops.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MaShops.Models.Cart", b =>
                {
                    b.HasOne("MaShops.Models.ApplicationUser", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("MaShops.Models.Store", b =>
                {
                    b.HasOne("MaShops.Models.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("MaShops.Models.StoreSave", b =>
                {
                    ...
                    b.HasOne("MaShops.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MaShops.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
